	...
	<div>
		<section v-if='level == 1'>
			...
			<el-table :data="dataForm" highlight-current-row v-loading="listLoading" style="width: 100%;">
				...
				<el-table-column prop='extra.phone' label="手机号" width="200" sortable>
				</el-table-column>
				<el-table-column prop='role.title' label="职务" width="150">
				</el-table-column>
				<el-table-column prop='branch' label="收款窗口" :formatter='formatBranch' width="150">
				</el-table-column>
				...
				<el-table-column label="操作" width='250'>
			      ...
			      <el-button
			          size="small"
			          type="primary"
			          @click="handleBindBranchEdit(scope.$index, scope.row)">绑定收款窗口</el-button>
			        <el-button
			          size="small"
