<template>
    ...
    <el-tab-pane label="案例" name="p1">
    	<!--工具条-->
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				<el-form-item>
					<el-input v-model="filters.name" placeholder="案例名称"></el-input>
				</el-form-item>
				<el-form-item>
					<el-button type="primary" v-on:click="getProducts">查询</el-button>
				</el-form-item>
				<el-form-item>
					<el-button  @click="handleAdd">新增案例</el-button>
				</el-form-item>
			</el-form>
		</el-col>
		...
		<!--新增界面-->
		<el-dialog title="新增案例" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="价格">
					<el-input-number v-model="addForm.price" :min="0" :max="1000000"></el-input-number>
				</el-form-item>
		...
		<!--编辑界面-->
		<el-dialog title="修改案例" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="价格">
					<el-input-number v-model="editForm.price" :min="0" :max="1000000"></el-input-number>
				</el-form-item>
		...
		<!--显示详情-->
		<el-dialog title="案例详情" v-model="showFormVisible" :close-on-click-modal="false">
			<el-row>
			<el-col :span="6">
				案例ID:
			</el-col>
			...
			<el-col :span="18">
				<img :src="showForm.basic && showForm.basic.avatar" class="single-image" />
			</el-col>
			</el-row>
			<el-row style="margin-top:5px;">
			<el-col :span="6">
			...
			<el-col :span="18">
				¥{{ showForm.basic && showForm.basic.price }}
			</el-col>
			</el-row>
			...
			<el-col :span="18">
				<p>{{ showForm.basic && showForm.basic.text }}</p>
			</el-col>
			</el-row>
			<el-row style="margin-top:5px;">
			<el-col :span="6">
			...
			<el-col :span="18">
				<img :src="item.url" v-for="item in showForm.basic && showForm.basic.images" class="single-image"/>
			</el-col>
			</el-row>
			<el-row style="margin-top:5px;">
			<el-col :span="6">
...
<script>
	...
	import { getHssyCaseList, addHssyCase, editHssyCase, removeHssyCase, addHssyCatalog, getHssyCatalogList, editHssyCatalog, removeHssyCatalog } from '../../api/api';
	...
	export default {
		...
		methods: {
			...
			handleDel: function (index, row) {
				this.$confirm('确认删除案例：'+row.basic.title+' 吗?', '提示', {
					type: 'warning'
				}).then(() => {
					this.listLoading = true;
					//NProgress.start();
