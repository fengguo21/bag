<template>
	<section>
		...
		<el-table :data="products" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="basic.stock" label="库存" width="200" >
			</el-table-column>
			...
			<el-table-column label="操作" width="250">
				<template scope="scope">
					...
					<el-button size="small" type="primary" @click="handleEditStock(scope.$index, scope.row)">库存</el-button>
		...
		<!--新增界面-->
		<el-dialog title="新增商品" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="提成金额">
					...
					<el-row v-for="(i, index) in percentages" :key='index'>
						<el-col :span="12" style="margin-bottom:10px">
						<el-input-number v-model="i.count"></el-input-number>
						</el-col>
						<el-col :span="12">
						<el-input-number v-model="i.percentage"></el-input-number>
						</el-col>
					</el-row>
					<el-button type="danger" icon="minus" @click="minusPercentage"></el-button>
					<el-button type="primary" icon="plus" @click="plusPercentage"></el-button>
				</el-form-item>
				...
				<el-form-item label="重量">
					<el-input-number v-model="addForm.weight"></el-input-number> kg
				</el-form-item>
		...
		<!--编辑界面-->
		<el-dialog title="修改商品" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="重量">
					<el-input-number v-model="editForm.weight"></el-input-number> kg
				</el-form-item>
		...
		<!--编辑库存界面-->
		<el-dialog title="修改商品库存" v-model="editStockFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="标题" prop="title">
					{{editForm.title}}
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			handleEdit: function (index, row) {
				...
				this.percentages = this.editForm.percentages
			},
			//显示编辑界面
			...
			handleAdd: function () {
				...
				console.log('handleAdd', this.albumList)
			},
			//显示新增界面
				...
				this.$refs.editForm.validate((valid) => {
					if (valid) {
						this.$confirm('确认提交吗？', '提示', {}).then(() => {
							...
							para.percentages = this.percentages
