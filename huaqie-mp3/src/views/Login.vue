...
<div class="full-screen">
 <c-waves>
    ...
    <el-form-item style="width:100%;">
      ...
      <el-button style="margin-top:20px;" type="text" @click.native.prevent="handleReset2">忘记密码？</el-button>
    </el-form-item>
  </el-form>
      </div>
    </c-waves>
...
<script>
  import { getSessionId, requestLogin, getMasterApp } from '../api/api';
            ...
            requestLogin(loginParams).then(ret => {
              ...
              if(!ret.data.app){
                ...
                return
                  ...
                  session.set('user', ret.data.people)
                  session.set('app', ret.data.app)
                  this.$router.push({ path: `/${ret.data.app.extra.group}/page1000` });
