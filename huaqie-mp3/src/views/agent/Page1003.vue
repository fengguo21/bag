<template>
    ...
    <el-tab-pane label="收入明细" name="second">
		...
		<el-table :data="transactions" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="name" label="金额" width="120" sortable>
			</el-table-column>
			<el-table-column prop="sex" label="订单号" width="100"  sortable>
			</el-table-column>
			<el-table-column prop="addr" label="支付人" width="100" sortable>
			</el-table-column>
			<el-table-column prop="age" label="支付方式" width="120" sortable>
			</el-table-column>
			<el-table-column prop="birth" label="支付时间" min-width="180" sortable>
			</el-table-column>
