	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-input v-model="filters.text" placeholder="备注"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="feedbacks" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="basic.title" label="主题" width="200" >
			</el-table-column>
			<el-table-column prop="basic.deviceCode" label="设备号" width="200" >
			</el-table-column>
			<el-table-column prop="basic.text" label="备注" width="auto" >
			</el-table-column>
...
<script>
	...
	import { getBatteryChargeFeedbackListPage, removeBatteryChargeFeedback } from '../../api/api';
	...
	export default {
		...
		methods: {
			...
			getFeedbacks() {
				...
				//NProgress.start();
				getBatteryChargeFeedbackListPage(para).then((res) => {
					if(res.code){
						this.$message.error({
							message: res.message
						})
			...
			handleDel: function (index, row) {
				this.$confirm('确认删除该记录吗?', '提示', {
					...
					removeBatteryChargeFeedback(para).then((res) => {
						this.listLoading = false;
						//NProgress.done();
						this.$message({
							message: '删除成功',
