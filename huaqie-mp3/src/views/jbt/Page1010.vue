	...
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
					<el-button type="primary" v-on:click="getEntities()">查询</el-button>
				</el-form-item>
				<!--<el-form-item>
		...
		<el-table :data="entities" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="basic.name" label="姓名" width="200" sortable>
			</el-table-column>
			<el-table-column prop="basic.phone" label="电话" width="200" sortable>
			</el-table-column>
			<el-table-column prop="basic.date" label="预约日期" width="200" sortable>
			</el-table-column>
			<el-table-column prop="created" label="提交时间" :formatter="formatTime" sortable>
			</el-table-column>
