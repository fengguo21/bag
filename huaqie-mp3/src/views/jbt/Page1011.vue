<template>
	<section>
		...
		<el-table :data="entities" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="basic.code" label="Vin码" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.title" label="商品标题" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.price" label="价格" width="150" :formatter="formatMoney" sortable>
			</el-table-column>
			<el-table-column prop="basic.level" label="等级" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.place" label="产地" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.date" label="出厂日期" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.productId" label="绑定商品ID" width="150" sortable>
			</el-table-column>
			<el-table-column prop="basic.text" label="简介"  sortable>
			</el-table-column>
		...
		<!--编辑界面-->
		<el-dialog title="编辑Vin码" v-model="editFormVisible" :close-on-click-modal="false">
		...
		<!--新增界面-->
		<el-dialog title="新增Vin码" v-model="addFormVisible" :close-on-click-modal="false">
	...
	export default {
		...
		methods: {
			...
			formatMoney: function(row, column) {
				return '¥'+row.basic.price.toFixed(2)
			},
			...
			handleEdit: function (index, row) {
				...
				this.editForm = Object.assign({}, {
					...
					place: row.basic.place,
					level: row.basic.level,
