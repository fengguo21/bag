	...
	<div class="overview-wrap">
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			<el-form :inline="true" :model="filters">
				...
				<el-form-item>
				<el-select style='width: 100%' clearable v-model="filters.peopleId" placeholder="选择收银员">
		      <el-option :label="item.label" :value="item.value" v-for='(item, key) in roleOptions' :key='key'></el-option>
		    </el-select>
				</el-form-item>
				<el-form-item>
		...
		<el-table :data="incomeForm" highlight-current-row v-loading="listLoading" style="width: 100%;">
			...
			<el-table-column prop="amount" label="收款金额" width='200'  :formatter='formatMoney'>
			</el-table-column>
			<el-table-column prop="basic.channel" label="支付方式" width='200' :formatter='formatChannel' >
			</el-table-column>
			<el-table-column prop="basic.text" label="备注" width='250'>
			</el-table-column>
			<el-table-column prop="created" label="收款日期" :formatter="formatDate" width="auto" >
			</el-table-column>
		</el-table>
		...
		<el-dialog title="生成报表" v-model="reportVisible">
		  <el-form :model="reportForm" :rules='reportRules' label-width="140px" ref="reportForm">
				...
				<el-select v-model="reportForm.branchId" placeholder="请选择收银员">
		      <el-option :label="item.label" :value="item.value" v-for='(item, key) in roleOptions' :key='key'></el-option>
		    </el-select>
				</el-form-item>
