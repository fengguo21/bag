<template>
  <div class="quanbox">
    ...
    <div class="cont">
      ...
      <p>1.消费满额赠优惠券兑换
        <ul>
          <li>• 非会员、电子会员当日单张购物小票满200元兑换1小时，最多兑换3小时</li>
          <li>• 银卡、特选银卡、金卡会员当日单张购物小票满100元兑换1小时，最多兑换3小时</li>
        </ul>
      </p>
      <p>2. 餐饮娱乐消费赠优惠券兑换
        <ul>
          <li> • 当日累计消费满100元兑换4小时</li>
        </ul>
      </p>
      <p>3.购物小票不隔日、跨日计算</p>
      <p>4.会员卡每日仅限1次优惠</p>
      <p style="word-break:break-all">5.如需多张购物小票叠加兑换，请至商场礼宾台/兑换时间:
        <br>&nbsp;&nbsp;&nbsp;10:00~22:00； 或至负四层停车缴费处/兑换时间:24小时
      </p>
      <p>6.每个微信账户或会员账户每日/每次停车限享受1次停车优惠</p>
      <p>7.停车超出免费时间，按5元/小时计费</p>
