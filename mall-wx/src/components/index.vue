<template>
  <div class="memberbox">
    <div class="popbox" v-show="dialogVisible1">
      <div class="mask" @click="dialogVisible1=false"></div>
      <div class="popshow">
        <div class="cont">
          <div @click="dialogVisible1=false" class="icon_close">
    ...
    <div class="membercenter">
      ...
      <div class="iconlist">
        <el-row>
          <el-col :span="8">
            <router-link :to="{name:'mygold',query:{time:new Date()}}">
...
<style lang="less" rel="stylesheet/less">
  ...
  .popshow {
    /* position:absolute;left:50%;top:30vh;z-index:999;width:70%;margin-left:-35%; */
  }
...
.iconlist{padding-bottom:1rem;font-size:@ttsize2;}
  ...
  .popbox{position:fixed;z-index:99;width:100%;height:100%;}
    .popshow {
    position: absolute;
    left: 50%;
    top: 20%;
